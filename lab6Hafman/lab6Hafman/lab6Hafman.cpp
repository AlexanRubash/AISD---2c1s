...
int main()
{
	...
	// Создал таблицу встречаемости элементов в тексте
	...
	// Создал вектор пар(индекс встречаемости, строка символов) и отсортировал его по индексу встречаемости.
	...
	// Создал вектор пар(символ, строка-зашифровка)
	...
	cout << endl << endl << "Таблицу соответствия символа и кодовой последовательности:" << endl;
	for (size_t i = 0; i < symbolCipher.size(); i++)
	{
		cout << "( " << symbolCipher[i].first << " - " << symbolCipher[i].second << " )" << endl;
	}

	cout << endl << endl << "Выходная последовательность:" << endl;
